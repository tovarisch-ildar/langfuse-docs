...
| `AUTH_IGNORE_ACCOUNT_FIELDS`        | Comma-separated list of SSO provider's account fields that should be ignored during the account linking process to prevent potential issues with specific authentication providers. E.g. `level,organization`                                         |
